	...
	while (ca!=cd)
	{
		...
		for (y=0; y<466; y++)
		{
			for (x=0; x<284; x++)
			{
				...
				{
					if (gray.at<uchar>(y-1,x-1) <= 200 && imagem.at<uchar>(y-1,x-1) != 255)  
					{
						imagem.at<uchar>(y-1,x-1) = 255;
						cd++;
					}

					if (gray.at<uchar>(y-1,x) <=200 && imagem.at<uchar>(y-1,x) != 255)
					{
					...
					if (gray.at<uchar>(y,x-1) <=200 && imagem.at<uchar>(y,x-1) != 255)
					{
